...
SWIFT_CLASS("_TtC16ParseSwiftTestes11AppDelegate")
...
SWIFT_CLASS("_TtC16ParseSwiftTestes24Mini3TableViewController")
@interface Mini3TableViewController : UITableViewController
@property (nonatomic, copy) NSArray * __nonnull arrayHistorias;
- (void)viewDidLoad;
...
- (void)inserirHistoria;
- (void)loginTeste;
- (void)logout;
- (void)recuperarUsuarios;
- (void)recuperarHistorias;
- (void)requisicaoHistoriasTerminou;
- (void)relacionarComentario;
...
SWIFT_CLASS("_TtC16ParseSwiftTestes27OhMyZashTableViewController")
@interface OhMyZashTableViewController : UITableViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * __nonnull)tableView;
- (NSInteger)tableView:(UITableView * __nonnull)tableView numberOfRowsInSection:(NSInteger)section;
...
SWIFT_CLASS("_TtC16ParseSwiftTestes29ParseCloudTesteViewController")
@interface ParseCloudTesteViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)retornaJobsons:(id __nonnull)sender;
- (IBAction)insereJobson:(id __nonnull)sender;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC16ParseSwiftTestes24ParseTableViewController")
...
SWIFT_CLASS("_TtC16ParseSwiftTestes14ViewController")
